...
#Specify custommapper for ROI detection
...
def divide_label_unlabel(
    ...
    num_label = int(SupPercent / 100.0 * num_all) #Parse rather than specify w/ scandir
...
def build_detection_semisup_train_loader_two_crops(cfg, mapper):
    # Uncomment to use custom mapper but it might not work still
    # mapper = create_train_mapper(cfg)
