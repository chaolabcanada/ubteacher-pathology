...
class TrainUtil:
    ...
    def test_mapper(self, dataset_dict: List[Dict]):
        ...
        dataset_dict["image"] = image_tensor # HACKED: If something goes wrong its probably this
        return dataset_dict
...
class TrainHelper(TrainUtil):
    ...
    def unlabeled_registration(self, dset_type, dataset):
        reg_name = "ROI_" + dset_type
        print(f"working on '{reg_name}'...")
        DatasetCatalog.register(reg_name, lambda d=dset_type: dataset)
